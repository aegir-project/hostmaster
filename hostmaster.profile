 ...
 */
function hostmaster_install_tasks() {
  $tasks = array();

  $tasks['hostmaster_theme_task'] = array();

  $tasks['hostmaster_misc_task'] = array(
...
function hostmaster_misc_task() {

}

function hostmaster_theme_task() {
  $enable = array(
    'theme_default' => 'eldir',
  );
